...
namespace cube3D_WPF
{
    class Helpers
    {
        /*------------------------------------------------------------------------
                ...
                Gli Helpers sono per così dire degli "aiutanti", ovvero 
                delle classi o delle funzioni che permettono solitamente 
                di semplificare, al programmatore, l'uso di determinate 
                funzionalità che spesso possono essere utilizzate a supporto 
                delle view.
        --------------------------------------------------------------------------*/
